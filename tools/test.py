...
#                 ori_h, ori_w = img_meta['img_shape'][:-1]
#                 img_show = mmcv.imresize(img_show, (ori_w, ori_h))
#
#                 if out_dir:
#                     # out_file = osp.join(out_dir, img_meta['ori_filename'])
#                     out_file = osp.join(out_dir, 'out_'+img_meta['filename'])
#                 else:
#                     out_file = None
#
...
#                 show_result_obb(img_show, result, classes, show=show,
#                                 score_thr=show_score_thr, out_file=out_file)
#
