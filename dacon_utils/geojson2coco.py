...
if __name__ == '__main__':
    ...
    geojson2coco(imageroot=os.path.join(rootfolder, 'ori_train/images'),
                 geojsonpath=os.path.join(rootfolder, 'ori_train/json'),
                 destfile=os.path.join(rootfolder, 'ori_train/train.json'))
