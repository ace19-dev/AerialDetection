...
def prepare(srcpath, dstpath):
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024'),
                   os.path.join(dstpath, 'trainval1024', 'DOTA_trainval1024.json'), wordname_15, difficult='2')
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024_ms'),
                   os.path.join(dstpath, 'trainval1024_ms', 'DOTA_trainval1024_ms.json'), wordname_15, difficult='2')

    DOTA2COCOTest(os.path.join(dstpath, 'test1024'), os.path.join(dstpath, 'test1024', 'DOTA_test1024.json'),
                  wordname_15)
    DOTA2COCOTest(os.path.join(dstpath, 'test1024_ms'), os.path.join(dstpath, 'test1024_ms', 'DOTA_test1024_ms.json'),
                  wordname_15)
