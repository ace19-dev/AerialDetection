...
if __name__ == '__main__':
    ...
    geojson2coco(imageroot=os.path.join(rootfolder, 'patch2/images'),
                 geojsonpath=os.path.join(rootfolder, 'patch2/json'),
                 destfile=os.path.join(rootfolder, 'patch2/train.json'))
