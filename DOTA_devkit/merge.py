...
result_path = os.path.join(root, 'merged')
...
for idx, jd in enumerate(json_dirs):
    ...
    util.groundtruth2task(json_path, os.path.join(result_path, jd, 'task'))
    mergebypoly(os.path.join(result_path, jd, 'task'),
                os.path.join(result_path, jd, 'task_merged'))
    util.task2groundtruth_poly(os.path.join(result_path, jd, 'task_merged'),
                               os.path.join(result_path, jd, 'restored'))
